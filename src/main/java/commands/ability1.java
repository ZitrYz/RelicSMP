...
public class ability1 implements CommandExecutor {

	public ability1() {
		Bukkit.getServer().getPluginCommand("ability1").setExecutor(this);
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (relic_list.size() < 1) {
			p.sendMessage(ChatColor.RED + "You don't have any ability in 1st slot!");
			return false;
		}
		if (relic_list.get(0).getAbility() == null) {
			p.sendMessage(ChatColor.RED + "Relic in 1st slot doesn't have any active abilities!");
			return false;
		}
		Relic relic = relic_list.get(0);
